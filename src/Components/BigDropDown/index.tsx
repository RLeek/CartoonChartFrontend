...
const BigDropDownHref = (props:DropDownHrefProps) => {
    const values = props.values;
    const selected = props.value;
    const onChange = props.onChange;
    const [active, setActive] = useState(false);
    ...
    return (
        ...
        <div className = " relative">
            ...
            {active && 
                <div className = "text-right right-0 absolute bg-gray-750 mt-3 transform origin-top-right rounded-md py-2">
                    {values.map((value) =>
                        <div className = "cursor-pointer select-none hover:bg-gray-700  pr-7 pl-10 px-2 py-2 text-xl lg:text-2xl font-semibold" onMouseDown ={()=>history.push(onChange(value))}>
...
export { BigDropDown, BigDropDownHref};